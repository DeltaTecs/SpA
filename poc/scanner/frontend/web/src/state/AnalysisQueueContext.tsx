...
export interface CompletedEntry extends QueueEntry {
  ...
  /** Job that ran this entry. Set for entries that started (carried over from
   *  ActiveEntry); absent only when the entry errored before a job was created.
   *  Used to fetch the live tool-use transcript for the "Tool Transcript" button. */
  jobId?: string;
}
